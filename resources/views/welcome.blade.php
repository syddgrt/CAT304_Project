    ...
    <div class="container">
        ...
        <div class="card o-hidden border-4 shadow-lg my-5 ">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-try-image"></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h1 text-gray-900 mb-4">Welcome to ReporTruzz</h1>
                                <h1 class="h3 text-gray-900 mb-1">Infrastructural issues <br> reporting website</h1>
                            </div>
                            <hr>
                            <div class="text-center">
                                <a class="h4 text-gray-900 mb-1" href="/login">Use ReporTruzz now!!!</h1>
                            </div>
                        </div>
                    </div>
                </div>
